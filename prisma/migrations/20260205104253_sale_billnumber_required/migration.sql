...
CREATE TABLE "ProductVariant" (
    ...
    "default_selling_price" DOUBLE PRECISION NOT NULL,
...
-- CreateIndex
CREATE INDEX "ProductVariant_subcategoryId_idx" ON "ProductVariant"("subcategoryId");
...
-- AddForeignKey
ALTER TABLE "ProductVariant" ADD CONSTRAINT "ProductVariant_categoryId_fkey" FOREIGN KEY ("categoryId") REFERENCES "Category"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "Product" ADD CONSTRAINT "Product_productVariantId_fkey" FOREIGN KEY ("productVariantId") REFERENCES "ProductVariant"("id") ON DELETE CASCADE ON UPDATE CASCADE;
